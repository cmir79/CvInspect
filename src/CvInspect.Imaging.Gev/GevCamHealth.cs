...
/// 실측(Basler acA2500-14gm 한 대): 부른 뒤 몇 ms 안에 취소한 그랩은 자기 블록을 끊었고, 그런 취소 20번 묶음 8번 중 2번은
/// **바로 다음 그랩의 장까지** 끊겼다(취득 라이브러리 0.4.0·0.4.1 둘 다). 평범한 시한 초과는 끊지 않았다. 다른 기종은 안 쟀다.
/// 다음 장이 끊기던 것은 0.29.1 에서 막았다 — 장치가 시작 직후의 멈춤을 한 장 주기 뒤에 실행해 생긴 일이라, 장을 못 받고 끝난
/// 그랩 뒤에는 다음 시작을 그만큼 미룬다(GevCam 의 _nextStartNotBefore). 취소된 그랩 자신의 블록이 끊기는 것은 그대로다.
/// 두 계수가 멈출 때 주변에서만 오르는지 먼저 본다.
/// </summary>
